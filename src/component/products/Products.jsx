            ...
            <div className='w-full mt-16 mb-10 bg-white'>
                ...
                <div className='w-full flex justify-center'>
                    <div className='flex items-start justify-around xl:w-[40%] md:[60%]'>
                        <div className='border border-gray-400 cursor-pointer xl:w-40 md:w-32 sm:w-32 w-28 text-center py-2' onClick={handleSubCategosies}> Men</div>
                        <div className='border border-gray-400 cursor-pointer xl:w-40 md:w-32 sm:w-32 w-28 text-center py-2' onClick={handleSubCategosies}> Womens</div>
                        <div className='border border-gray-400 cursor-pointer xl:w-40 md:w-32 sm:w-32 w-28 text-center py-2' onClick={handleSubCategosies}> Kids</div>
                    </div>
                </div>
