      ...
      <div className='flex justify-around items-start bg-[black] h-fit py-10 flex-wrap '>
        ...
        <div className='xl:w-[150px] lg:w-[1500px] md:w-[150px] sm:w-[400px] w-[400px] mt-10'>
          ...
          <ul className='text-white gap-3 flex flex-col mx-auto'>
            ...
            <li><a className='hover:text-gray-500' href='/about-us'>About us</a></li>
            <li><a className='hover:text-gray-500' href='/our-services'>Our Services</a></li>
            <li><a className='hover:text-gray-500' href='/all-products'>Our Products</a></li>
            <li><a className='hover:text-gray-500' href='/contact-us'>Contact Us</a></li>
          </ul>
        </div>
