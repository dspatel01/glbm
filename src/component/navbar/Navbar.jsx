...
const Navbar = () => {
  ...
  return (
    <div className='w-full h-16 xl:relative lg:absolute md:sticky sm:sticky sticky md:top-0 sm:top-0 top-0 text-black xl:bg-transparent lg:bg-transparent transition-all md:bg-white sm:bg-white bg-white z-10'>
      ...
      <ul className={openMenu ? 'h-[100vh] w-[60%] bg-[rgba(255,255,255,0.8)] py-5 ml-0 transition-all xl:hidden lg:hidden md:block sm:block block' : 'transition-all h-[80vh] w-[60%] bg-[rgba(255,255,255,0.8)] py-5 ml-[-70%]'}>
        <li className='ml-20 mt-5' onClick={() => setOpenMenu(false)}>
